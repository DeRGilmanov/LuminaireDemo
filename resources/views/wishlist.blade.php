...
<main class="pt-90">
    ...
    <section class="shop-checkout container">
      ...
      <div class="shopping-cart">
        ...
        <div class="cart-table__wrapper">
          ...
          <table class="cart-table">
            ...
            <td>
                ...
                <div class = "col-6">
                    ...
                    @csrf
                        <button type="submit" class="btn btn-sm btn-warning">Переместить в корзину </button>
                      </form>
                </div>
                <div class = "col-6">
          ...
          <div class="cart-table-footer">
           <form method= "POST" action="{{route('wishlist.items.clear')}}">
            @csrf
            @method ('DELETE')
            <button type="submit" class="btn btn-light">ОЧИСТИТЬ СПИСОК</button>
           </form>
          </div>
        </div>
        @else
       <div class = "row">
        <div class = "col-md-12">
          <p>В вашем списке нет товаров</p>
          <a href ="{{route('shop.index')}}" class = "btn btn-info">Список товаров</a>
        </div>
       </div>
       @endif
      </div>
