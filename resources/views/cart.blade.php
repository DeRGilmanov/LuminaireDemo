...
<style>
    ...
    <main class="pt-90">
        ...
        <section class="shop-checkout container">
            ...
            <span>Товары</span>
            <em>Упраление списком товаров</em>
          </span>
                </a>
            ...
            <em>Проверка и подтверждение заказа</em>
          </span>
                </a>
            </div>
            <div class="shopping-cart">
                ...
                <div class="cart-table__wrapper">
                    ...
                    <div class="cart-table-footer">
                       ...
                       <form action="{{route('cart.coupon.apply')}}" method="POST" class="position-relative bg-body">
                        @csrf
                        <input class="form-control" type="text" name="coupon_code" placeholder="Введите промокод" value="">
                        <input class="btn-link fw-medium position-absolute top-0 end-0 h-100 px-4" type="submit" value="Применить промокод">
                    </form>
                       @else
                        <form action="{{route('cart.coupon.remove')}}" method="POST" class="position-relative bg-body">
                            @csrf
                            @method('DELETE')
                            <input class="form-control" type="text" name="coupon_code" placeholder="Введите промокод" value="@if(Session::has('coupon')){{Session::get('coupon')['code']}}   Применен @endif">
                            <input class="btn-link fw-medium position-absolute top-0 end-0 h-100 px-4" type="submit" value="Удалить промокод">
                        </form>
                       @endif
                    ...
                    <div class="sticky-content">
                        ...
                        <div class="mobile_fixed-btn_wrapper">
                            <div class="button-wrapper container">
                                <a href="{{route('cart.checkout')}}" class="btn btn-primary btn-checkout">ПЕРЕХОДИТЕ К ОФОРМЛЕНИЮ ЗАКАЗА</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class = "col-md-12-text-center pt-5 bp-5">
                        <p>Товар не найден в вашей корзине</p>
