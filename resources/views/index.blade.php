    ...
    <main>
        ...
        <div class="container mw-1620 bg-white border-radius-10">
            ...
            <section class="category-carousel container">
                <h2 class="section-title text-center mb-3 pb-xl-2 mb-xl-4">Вам может это понравиться</h2>
            ...
            <section class="hot-deals container">
                ...
                <div class="row">
                    <div
                        ...
                        <h2>Весення распродажа</h2>
                        <h2 class="fw-bold">Скидки до 60%</h2>
                        ...
                        <a href="{{route('shop.index')}}" class="btn-link default-underline text-uppercase fw-medium mt-3">Показать все</a>
                    </div>
            ...
            <section class="products-grid container">
                <h2 class="section-title text-center mb-3 pb-xl-3 mb-xl-4">Рекомендуем к покупке</h2>
                ...
                <div class="text-center mt-2">
                    <a class="btn-link btn-link_lg default-underline text-uppercase fw-medium" href="{{route('shop.index')}}">Показать больше</a>
                </div>
            </section>
        </div>
