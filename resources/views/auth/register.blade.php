                    ...
                    <div class="register-form">
                        <form method="POST" action="{{route('register')}}" name="register-form" class="needs-validation" novalidate="">
                            ...
                            <div class="d-flex align-items-center mb-3 pb-2">
                                <p class="m-0">Ваши персональные данные будут использоваться для поддержки вашей работы на этом веб-сайте, для
                                    управления доступом к вашей учетной записи и для других целей, описанных в нашей политике конфиденциальности.</p>
                            </div>

                            <button class="btn btn-primary w-100 text-uppercase" type="submit">Зарегистрироваться</button>

                            <div class="customer-option mt-4 text-center">
                                <span class="text-secondary">У вас есть аккаунт?</span>
                                <a href="{{route('login')}}" class="btn-text js-show-register">Войдите в свою учетную запись</a>
                            </div>
                        </form>
                    </div>
                </div>
