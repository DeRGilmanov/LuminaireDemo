        ...
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{route('admin.slide.update')}}" method="POST" enctype="multipart/form-data">
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Введите слоган" name="tagline" tabindex="0" value="{{$slide->tagline}}" aria-required="true" required="">
                </fieldset>
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Введите заголовок" name="title" tabindex="0" value="{{$slide->title}}" aria-required="true" required="">
                </fieldset>
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Введите подзаголовок" name="subtitle" tabindex="0" value="{{$slide->subtitle}}" aria-required="true" required="">
                </fieldset>
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Введите ссылку" name="link" tabindex="0" value="{{$slide->link}}" aria-required="true" required="">
                </fieldset>
                ...
                <fieldset class="category">
                    ...
                    <div class="select flex-grow">
                        <select class="" name="status" >
                            ...
                            <option value="1" @if($slide->status=="1") selected @endif>Активный</option>
                            <option value="0" @if($slide->status=="0") selected @endif>Неактивный</option>
                        </select>
                    </div>
                </fieldset>
