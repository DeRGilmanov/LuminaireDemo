            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    <div class="d-flex justify-content-between mb-4 pb-md-2">
                        ...
                        <div
                            ...
                            <a href="#" class="text-uppercase fw-medium"><svg width="10" height="10" viewBox="0 0 25 25"
                                ...
                                </svg><span class="menu-link menu-link_us-s">Prew</span></a>
                    ...
                    <div class="product-single__short-desc">
                        <p>{{$product->shoprt_description}}</p>
                    </div>
                    @if(Cart::instance('cart')->content()->where('id',$product->id)->count()>0)
                        <a href="{{route('cart.index')}}" class="btn btn-warning mb-3">Перейти в корзину </a>
                    @else
                    ...
                    <div class="product-single__addtolinks">
                        ...
                        <form method="POST" action="{{route('wishlist.item.remove', ['rowId'=>Cart::instance('wishlist')->content()->where('id',$product->id)->first()->rowId])}}" id="frm-remove-item">
                                   @csrf
                                   @method('DELETE')
                        <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist filled-heart" onclick ="document.getElementById('frm-remove-item').submit();" style="color: #EE82EE" ><svg width="16" height="16" viewBox="0 0 20 20"   fill="none" xmlns="http://www.w3.org/2000/svg">
                                <use href="#icon_heart" />
                        ...
                        @else
                            ...
                            <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist" onclick="document.getElementById('wishlist-form').submit();"><svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <use href="#icon_heart" />
                            </svg><span>Добавить в избранное</span></a>
                            </form>
                        @endif
                            ...
                            <details id="Details-share-template__main" class="m-1 xl:m-1.5" hidden="">
                                ...
                                <div id="Article-share-template__main"
                                    ...
                                    <button class="share-button__copy no-js-hidden">
                                        ...
                                        <span class="sr-only">Скопировать ссылку</span>
                                    </button>
                                </div>
                            </details>
                        </share-button>
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link nav-link_underscore" id="tab-reviews-tab" data-bs-toggle="tab" href="#tab-reviews"
                           role="tab" aria-controls="tab-reviews" aria-selected="false">Отзывы (2)</a>
                    </li>
                </ul>
